...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre></div><p>This will also ensure you have autocompletion \u{1F609} .</p>__VP_STATIC_END__`,21),p=[o];function c(i,u,l,r,d,k){return a(),s("div",null,p)}var x=n(e,[["render",c]]);export{g as __pageData,x as default};
